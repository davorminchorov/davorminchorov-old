<template>
    <div>
        ...
        <div class="pt-4 p-6 text-lg tracking-normal leading-normal">
            ...
            <br>
            <br>
            I am also a Senior PHP Developer as part of <a href="https://adevait.com/" target="_blank" rel="noreferrer" class="font-semibold text-green-500 hover:text-green-600 ">Adeva, an exclusive developers' network</a>, for about {{ withAdevaSince() }}.
            <br>
            <br>
        ...
        <div class="flex pl-6">
            ...
            <a href="https://github.com/davorminchorov" target="_blank" rel="noreferrer" class="pl-1">
                <svg class="h-12 w-12" viewBox="0 0 24 24">
            ...
            <a href="https://twitter.com/davorminchorov" target="_blank" rel="noreferrer" class="pl-1">
                <svg class="h-12 w-12" viewBox="0 0 24 24">
