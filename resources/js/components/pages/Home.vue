<template>
    <div>
        <div class="flex flex-col justify-around">
            <div class="gradient-green flex flex-col text-white rounded-lg">
                <dm-image></dm-image>
                <dm-info></dm-info>
            </div>
            <div class="flex flex-col items-center justify-center bg-white text-gray-900 border-2 rounded-lg border-white">
